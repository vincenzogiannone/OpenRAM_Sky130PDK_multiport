...
class cell_properties():
    ...
    def __init__(self):
        ...
        self.names["bitcell_1rw"] = "cell_1rw"
        self.names["bitcell_2rw"] = "cell_2rw"
        ...
        self._dec_cell2_2r1w = cell([ "A0", "B0","A1", "B1", "A2", "B2", "OUT0", "OUT1", "OUT2", "vdd", "gnd"],
                                   ["INPUT", "INPUT", "INPUT", "INPUT", "INPUT", "INPUT", "OUTPUT", "OUTPUT", "OUTPUT", "POWER", "GROUND"])
                                
        self._dec_cell3_2r1w = cell([ "A0", "B0", "C0", "A1", "B1", "C1", "A2", "B2", "C2", "OUT0", "OUT1", "OUT2", "vdd", "gnd"],
                                   ["INPUT", "INPUT", "INPUT", "INPUT", "INPUT", "INPUT", "INPUT", "INPUT", "INPUT", "OUTPUT", "OUTPUT", "OUTPUT", "POWER", "GROUND"])
                                   
        self._wordline_driver_cell = cell(["A0", "A1", "A2", "wl_en", "rwl0", "rwl1", "wwl0", "vdd", "gnd"],
                                         ["INPUT", "INPUT", "INPUT", "INPUT", "OUTPUT", "OUTPUT", "OUTPUT", "POWER", "GROUND"])
        ...
        self._write_driver_multiport = cell(['din', 'en', 'wbl', 'vdd', 'gnd'],
                                   ["INPUT", "INPUT", "OUTPUT", "POWER", "GROUND"])

        self._sense_amp = cell(['bl', 'br', 'dout', 'en', 'vdd', 'gnd'],
                                ["INPUT", "INPUT", "OUTPUT", "INPUT", "POWER", "GROUND"])

        self._sense_amp_multiport = cell(['rbl', 'dout', 'vdd', 'gnd'],
                                ["INPUT", "OUTPUT", "POWER", "GROUND"]) 

        self._bitcell_1rw = bitcell(["bl", "br", "wl", "vdd", "gnd"],
                                       ["OUTPUT", "OUTPUT", "INPUT", "POWER", "GROUND"])

        self._bitcell_2rw = bitcell(["bl0", "br0", "bl1", "br1", "wl0", "wl1", "vdd", "gnd"],
                                       ["OUTPUT", "OUTPUT", "OUTPUT", "OUTPUT", "INPUT", "INPUT", "POWER", "GROUND"])
                                       
        self._bitcell_2r1w = bitcell(["rbl0", "rbl1", "wbl0", "rwl0", "rwl1", "wwl0", "vdd", "gnd"],
                                       ["INOUT", "INOUT", "INPUT", "INPUT", "INPUT", "INPUT", "POWER", "GROUND"])

        self._col_cap_1rw = bitcell(["bl", "br", "vdd"],
                                       ["OUTPUT", "OUTPUT", "POWER"])

        self._row_cap_1rw = bitcell(["wl", "gnd"],
                                       ["INPUT", "POWER", "GROUND"])

        self._col_cap_2rw = bitcell(["bl0", "br0", "bl1", "br1", "vdd"],
    ...
    @property
    def dec_cell2_2r1w(self):
        return self._dec_cell2_2r1w
        
    @property
    def dec_cell3_2r1w(self):
        return self._dec_cell3_2r1w
        
    @property
    def wordline_driver_cell(self):
        return self._wordline_driver_cell
    ...
    @property
    def write_driver_multiport(self):
        return self._write_driver_multiport
    ...
    @property
    def sense_amp_multiport(self):
        return self._sense_amp_multiport

    @property
    def bitcell_1rw(self):
        return self._bitcell_1rw
    
    @property
    def bitcell_2rw(self):
        return self._bitcell_2rw
        
    @property
    def bitcell_2r1w(self):
        return self._bitcell_2r1w

    @property
    def col_cap_1rw(self):
        return self._col_cap_1rw

    @property
    def row_cap_1rw(self):
        return self._row_cap_1rw
    
    @property
    def col_cap_2rw(self):
        return self._col_cap_2rw

    @property
    def row_cap_2rw(self):
        return self._row_cap_2rw
    
    @property
    def col_cap_2r1w(self):
        return self._col_cap_2r1w

    @property
    def row_cap_2r1w(self):
        return self._row_cap_2r1w
