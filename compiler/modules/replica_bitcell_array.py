...
class replica_bitcell_array(bitcell_base_array):
    ...
    def add_bitline_pins(self):
        ...
        # Make a flat list too
            ...
            for col in range(self.column_size):
                for port in self.all_ports:
                    self.all_bitline_names.append(self.bitline_names[port][col])
        ...
        # All wordlines including dummy and RBL
            ...
            for row in range(self.row_size):
                for port in range(OPTS.num_all_ports):
                    self.all_wordline_names.append(self.wordline_names[port][row])
            self.add_pin_list(self.all_wordline_names, "INPUT")
    ...
    def create_layout(self):
        ...
        # Note that this doesn't include the row/col cap
            self.width = self.bitcell_array.width
