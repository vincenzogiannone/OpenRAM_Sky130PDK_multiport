...
class options(optparse.Values):
    ...
    wordline_driver_cell = "wordline_driver_cell"
    dec_cell2_2r1w = "dec_cell2_2r1w"
    dec_cell3_2r1w = "dec_cell3_2r1w"
    precharge = "precharge"
    precharge_multiport = "precharge_multiport"
    precharge_array = "precharge_array"
    precharge_array_multiport = "precharge_array_multiport"
    ptx = "ptx"
    replica_bitline = "replica_bitline"
    sense_amp_array = "sense_amp_array"
    sense_amp = "sense_amp"
    sense_amp_multiport = "sense_amp_multiport"
    tri_gate_array = "tri_gate_array"
    tri_gate = "tri_gate"
    wordline_driver = "wordline_driver"
    write_driver_array = "write_driver_array"
    write_driver = "write_driver"
    write_driver_multiport = "write_driver_multiport"
